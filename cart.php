            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="cart.php">Cart - <span class="cart-amunt">$1299</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">1</span></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="img/car-2.jpg" class="recent-thumb" alt="">
                            <h2><a href="single-product.php">Tuk-Tuk</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$998.00</ins> <del>$1499.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="img/car-3.jpg" class="recent-thumb" alt="">
                            <h2><a href="single-product.php">Mercedes-AMG G65</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$1599.00</ins> <del>$2499.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="img/car-4.jpg" class="recent-thumb" alt="">
                            <h2><a href="single-product.php">Lexus LX570</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$499.00</ins> <del>$799.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="img/car-5.jpg" class="recent-thumb" alt="">
                            <h2><a href="single-product.php">Lamborghini Huracan Performance</a></h2>
                            <div class="product-sidebar-price">
                                    ...
                                    <tbody>
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="single-product.php"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="img/carpro-9.jpg"></a>
                                            </td>

                                            <td class="product-name">
                                                <a href="single-product.php">Roll Royce Phatom VIII</a> 
                                            </td>
                                ...
                                <ul class="products">
                                    <li class="product">
                                        <a href="single-product.php">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="img/carpro-3.jpg">
                                            <h3>Mescedes Maybach GLS600</h3>
                                            <span class="price"><span class="amount">£1000.00</span></span>
                                        </a>
                                    ...
                                    <li class="product">
                                        <a href="single-product.php">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="img/carpro-4.jpg">
                                            <h3>Mescedes-Benz S600 Maybach</h3>
                                            <span class="price"><span class="amount">£1199.00</span></span>
                                        </a>
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            <th>Cart Subtotal</th>
                                            <td><span class="amount">£699.00</span></td>
                                        </tr>
                                        ...
                                        <tr class="order-total">
                                            <th>Order Total</th>
                                            <td><strong><span class="amount">£699.00</span></strong> </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2021 ShopKid'sToy. All Rights Reserved. <a href="http://www.facebook.com" target="_blank">TNGRich.com</a></p>
                    </div>
                </div>
